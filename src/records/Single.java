...
public class Single extends Record implements Disc{

    public Single(String recordName, String recordArtist, String discSpeed, String discSize, String year, int numberOfTracks, int numberOfDiscs) {
